...
def assign_timestamps_to_linestring(
    ...
    For each vertex in the linestring, the function locates the anchor segment it falls into and linearly interpolates its timestamp.
    """
    ...
    anchors = [
        (point, linestring.project(point), timestamp)
    ...
    for coord in linestring.coords:
        ...
        current_dist = linestring.project(current_point)
